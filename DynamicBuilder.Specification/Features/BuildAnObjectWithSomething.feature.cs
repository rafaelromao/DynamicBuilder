...
#line 9
 testRunner.When(string.Format("I request the builder to build an instance of type {0} with {1}", type, something), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
 testRunner.Then(string.Format("I will receive from the builder an instance of type {0} with {1}", type, something), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
